...
//     uint256 public poolTokenBalance = 100000;
//     uint256 public userTokenBalance = 100;

//     function deploy() public returns(DamnValuableToken,FlashLoanerPool,TheRewarderPool,AccountingToken,RewardToken) {
...
//         damnToken = new DamnValuableToken();
//         flashPool =  new FlashLoanerPool(address(damnToken));
//         rewarderPool = new TheRewarderPool(address(damnToken));
//         accToken = rewarderPool.accToken();
//         rewardToken = rewarderPool.rewardToken();

//         damnToken.transfer(address(flashPool), poolTokenBalance);
        
//         damnToken.approve(address(rewarderPool), userTokenBalance * 4);
//         rewarderPool.deposit( userTokenBalance * 4);
//         return (damnToken, flashPool, rewarderPool, accToken, rewardToken);
//     }
...
//     uint256 public MIN_DURATION = 5 days;
...
//     constructor() {
//         setUp  deployer = new setUp();
//         (damnToken, flashPool, rewarderPool, accToken, rewardToken) = deployer.deploy();
//     }
